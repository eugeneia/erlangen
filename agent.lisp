...
(defpackage erlangen.agent
  (:documentation
   "Node-local implementation of asynchrous _agents_ that can communicate
  via message passing. The interface is mostly equivalent to Erlang's
  processes except (1) without asynchronous exceptions and (2) without a
